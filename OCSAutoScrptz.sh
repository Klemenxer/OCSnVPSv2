...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/Klemenxer/OCSnVPSv2/master"
else
	source="https://raw.githubusercontent.com/Klemenxer/OCSnVPSv2/master"
fi
...
echo 'echo -e "                    Powered by LiteCore v2"' >> .bashrc
echo 'echo -e "                    Developed by Klemenxer"' >> .bashrc
...
cd /home/vps/public_html
wget https://raw.githubusercontent.com/Klemenxer/OCSnVPSv2/master/OCSPanel.zip
unzip OCSPanel.zip
rm -f OCSPanel.zip
chown -R www-data:www-data /home/vps/public_html
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels Modified by Klemenxer"  | tee -a log-install.txt
echo "                        "  | tee -a log-install.txt
echo "" | tee -a log-install.txt
